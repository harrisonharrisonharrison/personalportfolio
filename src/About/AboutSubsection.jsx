...
function AboutSubSection({ title, children }) {
  return (
    <div className="flex flex-col mb-2 last:mb-0 min-h-0">
      ...
      <div className="relative flex-1 min-h-0">
        ...
        <div className="absolute bottom-0 left-0 w-full h-10 bg-linear-to-t from-black to-transparent pointer-events-none z-10" />
      </div>
